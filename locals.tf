locals {
  ...
  host_header = var.component == "frontend" ? "${var.component}.frontend-alb-roboshop-${var.environment}.${var.domain_name}" : "${var.component}.backend-alb-${var.environment}.${var.domain_name}"
